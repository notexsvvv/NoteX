...
public class mapApprovalDeleteUser extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session != null) {
            ...
            if (token != null && token.equals(UserDaoImpl.getTokenforVerification(username))) {
                ...
                request.getRequestDispatcher("/WEB-INF/jsp/secured/admin/delete_approval.jsp").forward(request, response);
            } else {
