...
/**
 * Servlet implementation class mapUploadPyq
 */
public class mapUploadPyq extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session != null) {
            ...
            if (token != null && token.equals(UserDaoImpl.getTokenforVerification(username))) {
                ...
                request.getRequestDispatcher("/WEB-INF/jsp/secured/admin/upload_pyq.jsp").forward(request, response);
            } else {
