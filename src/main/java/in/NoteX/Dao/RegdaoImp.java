...
public class RegdaoImp {
	...
	public static boolean addUserUnderReviews(User user) {
	...
	public static boolean addUser(StudentUser user) {
		String query = "INSERT INTO studentUser (fullname, username, email, linkedin,mobile,usertype,collegeid,password,terms) VALUES (?, ?, ?,?, ?, ?,?, ?, ?)";
	...
	public static boolean addUser(TeacherUser user) {
		String query = "INSERT INTO teacherUser (fullname, username, email, linkedin,mobile,usertype,collegeid,password,terms) VALUES (?, ?, ?,?, ?, ?,?, ?, ?)";
